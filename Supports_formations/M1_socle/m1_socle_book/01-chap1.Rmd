...
Pour rejoindre le groupe des utilisateurs du ministères, vous pouvez écrire à la liste SYMPA : labo.communaute-r@developpement-durable.gouv.fr
...
- Lire des données de formats divers $\rightarrow$ attention, il peut être gourmand en ressources
...
La proposition du groupe de référents est de fournir une version installable de R intégrant un ensemble de packages estimés indispensables pour travailler avec ce logiciel. Vous pouvez trouver cette version à  [cette adresse](http://pne.metier.e2.rie.gouv.fr/suite-logicielle-r-r974.html)

## Des exemples de ce qu'on peut faire avec R :

- Le support de cette formation
- [Visualisation du compte du logement](http://dataviz.statistiques.developpement-durable.gouv.fr/csl/)
