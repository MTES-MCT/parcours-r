...
On peut importer n'importe quel format de données en R (Excel, SAT, Stata, SQL...). Beaucoup sont abordé lors du module 2. Pour ce module, nous ne voyons que l'importation de fichier .CSV. Si vous avez une base de données en Excel ou LibreOffice Calc, sauvegardez l'onglet que vous souhaitez en faisant "enregistrer sous" $\rightarrow$ "délimité CSV". 
