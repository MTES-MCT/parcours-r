...
<center>![](Figures/mutate.png)</center>
...
<center>![](Figures/select.png)</center>
...
<center>![](Figures/filter.png)</center>
...
```{r, eval = F}
selection_62 <- df[df$DEP == "62", c("CODGEO", "ZAU", "REG", "DEP", "densite")]
```
