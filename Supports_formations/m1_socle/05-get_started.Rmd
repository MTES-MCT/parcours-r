...
- activer l'ensemble des packages nécessaires (pour la formation, un [script](https://mtes-mct.github.io/parcours-r/documents/preparation_pack_install_libraries.R) permet d'installer tous les packages nécessaires)
