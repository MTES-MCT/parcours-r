...
```{r stat_8}
t <- select(base_extrait, ZAU, REG) %>% table
print(t)
```
...
Pour aller plus loin et ajouter des variables de pondération, calculer les profils-ligne ou profils-colonne, rendez-vous au [module 3 "Statistiques descriptives"](https://rawgit.com/MTES-MCT/parcours-r/master/Supports_formations/m3_stats_desc/_book/index.html) ou demander à un GF (Gentil Formateur).
