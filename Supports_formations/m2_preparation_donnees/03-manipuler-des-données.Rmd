...
**mutate()** possède une variante, **transmute()**, qui fonctionne de la même façon que **mutate()**, mais ne garde que les variables modifiées ou crées par le verbe.
...
Nous pouvons obtenir une matrice des différenntes valeurs calculées :
...
Exemple : création d'une variable résultat pour savoir si le résultat de nos analyses est bon ou non.
...
<center>![](pic/exercice1_enonce_v3.png)</center>
