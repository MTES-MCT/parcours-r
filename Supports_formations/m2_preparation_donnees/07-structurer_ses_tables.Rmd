...
Quel serait la verison *tidy* de notre fichier ?
...
<center>![](images/pivot_xx.gif)</center>

Reprenons notre table Insee d'estimation de population. Comment donc passer cette table en format tidy ?
...
Pour cela nous pouvons utiliser `separate()` du package `tidyr` également.
