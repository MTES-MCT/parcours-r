...
```{r chargement_packages, echo = FALSE, warning = FALSE, message = FALSE}
library (plyr)
library (tidyverse)
library (forcats)
library (lsr)
...
![](Figures/logos_tidyverse_forcats.png)
...
![http://perso.ens-lyon.fr/lise.vaudor/manipulation-de-facteurs-avec-forcats/](Figures/fct_recode.png)
```{r}
...
![http://perso.ens-lyon.fr/lise.vaudor/manipulation-de-facteurs-avec-forcats/](Figures/fct_relevel.png)
