...
- Coefficient de corrélation linéaire (Pearson) : $\rho_{XY}=\frac{\sigma_{XY}}{\sigma_{X} \cdot \sigma_{X}}$ avec $\sigma_{XY} = \frac{1}{n}\sum_{i=1}^n (x_i-\bar{x})(y_i-\bar{y})$ et $\sigma_x$ l'écart-type de X.
