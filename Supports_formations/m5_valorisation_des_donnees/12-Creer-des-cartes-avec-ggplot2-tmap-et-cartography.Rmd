...
# Créer des cartes avec ggplot2, tmap et Cartographie

## Faire des cartes avec ggplot2

### Les cartes choroplèthe

ggplot2,pour l'instant encore dans sa version de développement, intègre une fonction geom permettant l'utilisation de données géomatrique : **geom_sf**

Le premier exemple que nous allons pouvoir voir, c'est une carte choroplèthe

```{r chap12, echo=T,eval=T,fig.height=5,fig.width=12}
data("World")
