...
`ggplot2` intègre une fonction géométrique permettant l'utilisation de données géomatrique : **geom_sf()**

Le premier exemple que nous allons pouvoir voir, c'est une carte choroplèthe

```{r cart_1, echo=T,eval=T,fig.height=5,fig.width=12}
data("World")
...
```{r cart_2, echo=T,eval=T,fig.height=12,fig.width=12,warning=F}
data("World")
...
`Tmap` est un package dédié à la réalisation de cartes sous R. La syntaxe est très proche de ggplot,avec l'opérateur "+" pour enchainer les options.
