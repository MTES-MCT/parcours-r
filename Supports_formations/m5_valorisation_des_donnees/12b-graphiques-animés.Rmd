...
Le graphique précédent est bien sur illisible, un même pays voit ces données affichées pour toutes les années.
...
```{r gganimate2,,warning = FALSE,message = FALSE,error=FALSE, cache=TRUE}
...
```{r gganimate3,warning = FALSE,message = FALSE,error=FALSE,cache=TRUE}
...
```{r gganimate4,warning = FALSE,message = FALSE,error=FALSE, cache=TRUE}
...
Produire le nuage de point du croisement de la part communale des logements ayant une étiquette A,B,C en fonction de la part communale du parc récent.
