...
- ***hc_colors()*** permet de définir les couleurs utlisées. elle prend en parametre un vecteur de couleur de longueur égal à celui des modalités différentes de la variable utilisée dans l'aesthétique pour la couleur.
...
Highcharter permet de réaliser des graphiques à facette à partir d'une liste de graphiques réalisé avec Highcharter.
