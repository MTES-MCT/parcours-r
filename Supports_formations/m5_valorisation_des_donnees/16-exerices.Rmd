...
```{r chap16, eval=T,message=F,warning=F}
...
```{r exo4, eval=F,message=F,warning=F}
...
```{r eval=T,fig.height=8,fig.width=12,message=F,warning=F}
rpls_aggrege  %>% 
...
```{r exo6, eval=T,message=F,warning=F}
