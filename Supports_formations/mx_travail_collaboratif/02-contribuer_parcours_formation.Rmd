...
Il faut regarder en haut à droite de RStudio ![](img/projet-rs.png).
...
Pour cela, il faut cliquer sur le nom du projet puis `Close Project` ![](img/fermer-projet.png)
