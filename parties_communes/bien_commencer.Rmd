...
![](https://github.com/MTES-MCT/parcours-r/blob/parties_communes/parties_communes/images/creerprojet1.png){#id .class width=500}

- Cliquez sur *New Directory*.

![](https://github.com/MTES-MCT/parcours-r/blob/parties_communes/parties_communes/images/creerprojet2.png){#id .class width=500}
